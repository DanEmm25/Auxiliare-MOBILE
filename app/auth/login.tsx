...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const response = await fetch("http://192.168.1.50:8081/login", {
        method: "POST",
        headers: {
  ...
  const handleRequestReset = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "http://192.168.1.50:8081/request-password-reset",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleResetPassword = async () => {
    ...
    setResetLoading(true);
    try {
      const response = await fetch("http://192.168.1.50:8081/reset-password", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
